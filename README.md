...
- AWS credentials configured (if connecting to live data)

### Installation & Setup
```bash
# Clone the repository
git clone [repository-url]
cd caiseiro-frontend
...
cp .env.example .env
# Edit .env with your AWS configuration and API endpoints
...
### Features
- **Real-time Dashboard**: View live sensor data from vents and boilers
- **Historical Charts**: Analyze temperature, humidity, and equipment performance trends
- **Alert Management**: Monitor AI Agent decisions and notification history
- **Mockup Data**: Built-in test data for demonstration and development
- **Equipment Status**: Track the health and performance of farm equipment

### Testing with Mockup Data
The frontend includes mockup data generators for:
- Temperature variations throughout the day
- Equipment performance metrics
- AI Agent decision logs
- Historical alerts and notifications

```bash
# Run with mockup data (for demonstrations)
npm run dev:demo

# Run tests with AI Agent
